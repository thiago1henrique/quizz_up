...
<div
    ...
    <p className="text-xl font-medium text-slate-700 mt-3">Historia</p>
...
<div
    ...
    <p className="text-xl font-medium text-slate-700 mt-3">Português
        </p>
...
<div className="p-10 flex flex-col items-center text-center group   md:lg:xl:border-b hover:bg-slate-50 cursor-pointer">
    ...
    <p className="text-xl font-medium text-slate-700 mt-3">Filosofia </p>
...
<div className="p-10 flex flex-col items-center text-center group   md:lg:xl:border-r hover:bg-slate-50 cursor-pointer">
    ...
    <p className="text-xl font-medium text-slate-700 mt-3">Matemática
        </p>
...
<div className="p-10 flex flex-col items-center text-center group    md:lg:xl:border-r hover:bg-slate-50 cursor-pointer">
    ...
    <p className="text-xl font-medium text-slate-700 mt-3">Fisica
        </p>
...
<div className="p-10 flex flex-col items-center text-center group     hover:bg-slate-50 cursor-pointer">
    ...
    <p className="text-xl font-medium text-slate-700 mt-3">Biologia
        </p>
